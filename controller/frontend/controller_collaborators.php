<?php 
	//class controller_collaborators ket thuc class controller de co the tac dong duoc vao cac ham cua class model thong qua thuoc tinh model cua class controller
	class controller_collaborators extends controller{
		...
		public function __construct(){
			...
			//-----------
			//load view
			include "view/frontend/view_collaborators.php";
		}
	}
	new controller_collaborators();
 ?>