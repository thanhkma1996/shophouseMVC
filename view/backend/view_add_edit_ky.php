<div class="col-md-8 col-md-offset-2">
	<div class="panel panel-primary">
		<div class="panel-heading">Add edit kỷ yếu</div>
		<div class="panel-body">
			<form class="form-horizontal" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-md-10">
					<input type="checkbox" <?php echo isset($arr->c_hotky)&&$arr->c_hotky==1?"checked":""; ?> name="c_hotky"> Hot ky
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-md-2"></label>
					<div class="col-md-10">
					<?php if(isset($arr->c_img)&&file_exists("public/upload/ky/".$arr->c_img&&$arr->c_img!="")){ ?>
					<img src="public/upload/ky/<?php echo $arr->c_img; ?>" style="max-width: 100px;">
					<?php } ?>
					</div>
				</div>
				<div class="form-group">
