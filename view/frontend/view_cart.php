<div class="template-cart">
          <form action="nang-cap" method="post">
              ...
              <table class="table table-cart">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="san-pham/chi-tiet/<?php echo remove_unicode($product["pk_product_id"]); ?>"><?php echo $product["c_name"]; ?></a></td>
                    ...
                    <td><a href="xoa-gio-hang/<?php echo remove_unicode($product["pk_product_id"]); ?>" data-id="2479395"><i class="fa fa-trash"></i></a></td>
                  </tr>
                  <?php } ?>
                </tbody>
                <tfoot>
                  <tr>
                    <td colspan="6"><a href="huy" class="button pull-left">Xóa toàn bộ</a> <a href="trang-chu" class="button pull-right black">Tiếp tục mua hàng</a>
          ...
          <div class="total-cart"> Tổng tiền thanh toán: 
            ...
            <a href="thanh-toan" class="button black">Thanh toán</a> <?php } ?></div>
