              ...
              <div class="col-xs-12 col-md-6 info">
                ...
                <p class="desc rte"> <?php echo $arr->c_description; ?></p>
                  ...
                  <div class="action-btn" style="text-align: left;">
                    <button class="button product-add-to-cart" onclick="location.href='chon-san-pham/chi-tiet/<?php echo remove_unicode($arr->pk_product_id); ?>';">Cho vào giỏ hàng</button>
                  </div>
              </div>
            </div>
          </div>
